...
RSpec.describe SedesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all sedes as @sedes" do
      ...
      expect(assigns(:sedes)).to eq([sede])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested sede as @sede" do
      ...
      expect(assigns(:sede)).to eq(sede)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new sede as @sede" do
      ...
      expect(assigns(:sede)).to be_a_new(Sede)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created sede as @sede" do
        post :create, {:sede => valid_attributes}, valid_session
        expect(assigns(:sede)).to be_a(Sede)
        expect(assigns(:sede)).to be_persisted
      end

      it "redirects to the created sede" do
        post :create, {:sede => valid_attributes}, valid_session
        expect(response).to redirect_to(Sede.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved sede as @sede" do
        post :create, {:sede => invalid_attributes}, valid_session
        expect(assigns(:sede)).to be_a_new(Sede)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested sede" do
        sede = Sede.create! valid_attributes
        put :update, {:id => sede.to_param, :sede => new_attributes}, valid_session
        sede.reload
      ...
      it "redirects to the sede" do
        sede = Sede.create! valid_attributes
        put :update, {:id => sede.to_param, :sede => valid_attributes}, valid_session
        expect(response).to redirect_to(sede)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the sede as @sede" do
        sede = Sede.create! valid_attributes
        put :update, {:id => sede.to_param, :sede => invalid_attributes}, valid_session
        expect(assigns(:sede)).to eq(sede)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the sedes list" do
      sede = Sede.create! valid_attributes
      delete :destroy, {:id => sede.to_param}, valid_session
      expect(response).to redirect_to(sedes_url)
    end
  end

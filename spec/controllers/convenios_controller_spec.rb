...
RSpec.describe ConveniosController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved convenio as @convenio" do
        post :create, {:convenio => invalid_attributes}, valid_session
        expect(assigns(:convenio)).to be_a_new(Convenio)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested convenio" do
        convenio = Convenio.create! valid_attributes
        put :update, {:id => convenio.to_param, :convenio => new_attributes}, valid_session
        convenio.reload
    ...
    context "with invalid params" do
      it "assigns the convenio as @convenio" do
        convenio = Convenio.create! valid_attributes
        put :update, {:id => convenio.to_param, :convenio => invalid_attributes}, valid_session
        expect(assigns(:convenio)).to eq(convenio)
      end
